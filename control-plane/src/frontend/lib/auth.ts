    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        try {
          ...
          // Backend accepts username (users can login with username or email if username was set to email)
          ...
          return {
            ...
            name: `${userData.first_name || ''} ${userData.last_name || ''}`.trim() || userData.username || userData.email,
            ...
            isCompanyAdmin: userData.is_company_admin,
            companyId: userData.company?.id || userData.company_id,
