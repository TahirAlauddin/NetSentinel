...
export function EditCompany({ onCancel, initialData }: EditCompanyProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-card border border-border rounded-lg p-8 space-y-8 max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Input name="subdomain" value={formData.subdomain} onChange={handleChange} placeholder="e.g., mycompany" />
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  Company URL <span className="text-xs text-muted-foreground">(i.e. www.mycompanyurl.com)</span>
                </label>
                <Input
                  name="companyUrl"
              ...
              {/* Main Contact */}
              <div>
                <label className="block text-sm font-medium mb-2">Main Contact</label>
                <Input
                  name="mainContact"
                  type="email"
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">We'll notify this contact on major account changes.</p>
              </div>

              {/* Phone Number */}
              <div className="space-y-2">
                <label className="block text-sm font-medium">Main Phone Number</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Fiscal Year Start Date</label>
                <div className="flex gap-4">
                  <select
            ...
            <div className="space-y-4 border-t border-border pt-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Free modules: Telecom, Network Monitoring, Marketplace</p>
                </div>
                <input
                  type="checkbox"
