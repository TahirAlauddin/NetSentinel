...
class TestAssetTagViewSet:
    ...
    def test_create_asset_tag_success(self, authenticated_api_client):
...
class TestVendorViewSet:
    ...
    def test_create_vendor_success(self, authenticated_api_client):
...
class TestAssetCategoryViewSet:
    ...
    def test_category_assets_action(self, authenticated_api_client):
...
class TestAssetViewSet:
    ...
    def test_list_assets_success(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get("/api/v1/assets/")
        assert response.status_code == status.HTTP_200_OK
        assert response.data["count"] == 2

    def test_create_asset_success(self, authenticated_api_client):
    ...
    def test_filter_assets_by_category(self, authenticated_api_client):
    ...
    def test_filter_assets_by_status(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get("/api/v1/assets/?status=active")
        assert response.status_code == status.HTTP_200_OK
        assert response.data["count"] == 1
        assert response.data["results"][0]["status"] == "active"

    def test_search_assets_by_name(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get("/api/v1/assets/?search=Dell")
        assert response.status_code == status.HTTP_200_OK
        assert response.data["count"] == 1
        assert "Dell" in response.data["results"][0]["name"]

    def test_search_assets_by_asset_tag(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get("/api/v1/assets/?search=LAP-001")
        assert response.status_code == status.HTTP_200_OK
        assert response.data["count"] == 1

    def test_asset_stats_action(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get("/api/v1/assets/stats/")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_asset_attachments_action(self, authenticated_api_client, user):
    ...
    def test_asset_related_assets_action(self, authenticated_api_client):
    ...
    def test_add_related_asset_action(self, authenticated_api_client):
    ...
    def test_remove_related_asset_action(self, authenticated_api_client):
...
class TestComputerDetailsViewSet:
    ...
    def test_list_computer_details_success(self, authenticated_api_client):
        ...
        response = authenticated_api_client.get("/api/v1/assets/computer-details/")
        assert response.status_code == status.HTTP_200_OK
        assert response.data["count"] == 1
...
class TestAssetImageViewSet:
    ...
    def test_list_asset_images_requires_valid_asset(self, authenticated_api_client):
...
class TestCalendarAlertViewSet:
    ...
    def test_create_calendar_alert_success(self, authenticated_api_client, user):
