...
from .views import (CarrierContactViewSet, CategoryViewSet, CircuitViewSet,
                    ContactViewSet, DepartmentViewSet, LocationViewSet,
                    PointOfContactViewSet, UtilityContactViewSet)
